...
/* user/show.html.twig */
class __TwigTemplate_27184c5e59b8e57ec2f82791fdd558d09a344c056c126c6a2ced445f8ca34855 extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        ...
        echo "\">Retourner a la list</a>

    <a href=\"";
        // line 36
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_user_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 36, $this->source); })()), "id", [], "any", false, false, false, 36)]), "html", null, true);
        echo "\">Modifier</a>
...
{% block body %}
    ...
    <a href=\"{{ path('app_user_index') }}\">Retourner a la list</a>

    <a href=\"{{ path('app_user_edit', {'id': user.id}) }}\">Modifier</a>

    {{ include('user/_delete_form.html.twig') }}
{% endblock %}
", "user/show.html.twig", "C:\\Users\\MSI\\Desktop\\Ichariot\\templates\\user\\show.html.twig");
    }
}
